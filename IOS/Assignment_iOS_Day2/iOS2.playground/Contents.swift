...
personalArray.append(PersonalInformation(employeeID: 121, name: "Ashish Singh", country: definedCountry.India, address: "Delhi", hobbies: nil))
personalArray.append(PersonalInformation(employeeID: 122, name: "Jane Wick", country: definedCountry.America, address: "Cannada", hobbies: "Rugby"))
...
professionalArray.append(ProfessionalInformation(employeeID: 121, name: "Ashish Singh", department: definedDepartment.iOS, branch: definedBranch.India, experience: 2))
...
professionalArray.append(ProfessionalInformation(employeeID: 123, name: "Eliza", department: definedDepartment.JVM, branch: definedBranch.Britain, experience: 3))
